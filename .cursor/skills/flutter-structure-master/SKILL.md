...
Use this skill first for any question about **where code lives**, **how layers connect**, **design tokens**, **build_runner**, or **iOS/Android quirks** in this repo. Then open the **sub-skill** that matches the task (paths below).
